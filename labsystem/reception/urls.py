...
urlpatterns = [
    ...
    path("queue/<int:queue_entry_id>/send-to-module/", views.receptionist_queue_send_to_module, name="reception_queue_send_to_module"),
    path("queue/<int:queue_entry_id>/send-to-phlebotomy/", views.receptionist_queue_send_to_phlebotomy, name="reception_queue_send_to_phlebotomy"),
    ...
    path("visits/<int:visit_id>/send-to-module/", views.visit_send_to_module, name="visit_send_to_module"),
    # path("visits/<int:visit_id>/edit-date/", views.visit_edit_date, name="visit_edit_date"),
    ...
    path("complete/<int:visit_id>/services/<int:visit_service_id>/remove/", views.remove_visit_service_api, name="remove_visit_service_api"),
