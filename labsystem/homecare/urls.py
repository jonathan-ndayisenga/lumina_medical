...
urlpatterns = [
    ...
    path("nurses/<int:nurse_id>/delete/", views.delete_nurse, name="homecare_delete_nurse"),
    ...
    path("clients/<int:client_id>/delete/", views.delete_client, name="homecare_delete_client"),
    ...
    path("placements/<int:placement_id>/terminate/", views.terminate_placement, name="homecare_terminate_placement"),
